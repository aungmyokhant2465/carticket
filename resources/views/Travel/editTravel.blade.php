    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"><a href="{{route('get.travelsWithAndWithoutTime')}}" class="btn btn-outline-secondary"><i class="fa fa-backward"></i></a></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('welcome')}}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{route('get.travelsWithAndWithoutTime')}}">Travel with and without time</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="post" action="{{route('post.editTravelWithAndWithoutTime')}}">
                            <div class="row">
                                <div class="col-10"></div>
                                <div class="col-2">
                                    <button style="top: 3px; right: 2px;" type="submit" class="btn btn-outline-info btn-block btn-lg">Update</button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <h5 class="text-secondary"><em>Add Medium Cities or not (already exist)</em></h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control custom-select @if($errors->has('start_city')) is-invalid @endif" name="start_city" id="start_city">
                                                                ...
                                                                @foreach($cities as $city)
                                                                    <option @if($city->City_name == $travel->start_city) selected @endif >{{$city->City_name}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <select class="form-control custom-select @if($errors->has('stop_city')) is-invalid @endif" name="stop_city" id="stop_city">
                                                                <option></option>
                                                                @foreach($cities as $city)
                                                                    <option @if($city->City_name == $travel->stop_city) selected @endif>{{$city->City_name}}</option>
                                                                @endforeach
                                                            </select>
