    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"><a href="{{route('get.travels')}}" class="btn btn-outline-secondary"><i class="fa fa-backward"></i></a></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active"><a href="{{route("welcome")}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Edit Travel Time</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="post" action="{{route('post.editTravelTime')}}">
                            <div class="row">
                                <div class="col-10"></div>
                                <div class="col-2">
                                    <button style="top: 3px; right: 2px;" class="mb-3 btn btn-outline-info btn-block btn-lg">Update</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tt">
                                                        <dvi class="form-group">
                                                            <input value="{{$travelTime->start_time}}" name="start_time" id="duration_start" type="text" class="form-control duration dur @if($errors->has('start_time')) is-invalid @endif"/>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                <input value="{{$travelTime->stop_time}}" name="stop_time" id="duration_stop" type="text" class="form-control duration dur @if($errors->has('stop_time')) is-invalid @endif"/>
                                                    ...
                                                    <li class="list-group-item shadow m-2">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-7">
                                                                <dvi class="form-group">
                                                                    <label>Time</label>
                                                                    <input name="t{{$medium['city']}}" type="text" class="form-control duration" value="{{$medium['time']}}"/>
                                                                </dvi>
                                                            </div>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text">
                                                                    <input @if($car->id == $travelTime->Car->id) checked @endif type="radio" name="car_id" value="{{$car->id}}" class="form-control @if($errors->has('car_id')) is-invalid @endif">
                            ...
                            <input type="hidden" name="travelTime_id" value="{{$travelTime->id}}">
                            {{csrf_field()}}
                        </form>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-10 offset-1 text-center">
                        <dvi style="display: none; position: fixed; bottom: 100px; left: 0; right: 0;" id="warn" class="alert alert-warning fixed-bottom" role="alert">
