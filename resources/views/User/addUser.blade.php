    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('post.addUser')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="tel" class="form-control @if($errors->has('phone')) is-invalid @endif" name="phone" id="phone">{{old('phone')}}</textarea>
                                                @if($errors->has('phone'))<span class="invalid-feedback">{{$errors->first('phone')}}</span> @endif
                                            </div>
                                            <div class="form-group">
                                                <label for="shop_name">Shop name</label>
                                                <input type="text" name="shop_name" id="shop_name" class="form-control @if($errors->has('shop_name')) is-invalid @endif" value="{{old("shop_name")}}">
